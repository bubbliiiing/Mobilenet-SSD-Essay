...
def get_anchors(img_size = (300,300), anchors_size=[30,60,111,162,213,264,315]):
    if img_size == (512,512):
        features_map_length = [32,16,8,4,2,1]
    ...
    priorbox = PriorBox(img_size, anchors_size[4], max_size=anchors_size[5], aspect_ratios=[2, 3],
                        variances=[0.1, 0.1, 0.2, 0.2],
                        name='conv8_2_mbox_priorbox')
    net['conv8_2_mbox_priorbox'] = priorbox.call([features_map_length[4],features_map_length[4]])


    priorbox = PriorBox(img_size, anchors_size[5], max_size=anchors_size[6], aspect_ratios=[2, 3],
                        variances=[0.1, 0.1, 0.2, 0.2],
