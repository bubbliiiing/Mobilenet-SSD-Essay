...
def SSD300(input_shape, num_classes=21, anchors_size=[30,60,111,162,213,264,315]):
    ...
    priorbox = PriorBox(input_shape, anchors_size[4], max_size=anchors_size[5], aspect_ratios=[2, 3],
                        variances=[0.1, 0.1, 0.2, 0.2],
    ...
    priorbox = PriorBox(input_shape, anchors_size[5], max_size=anchors_size[6], aspect_ratios=[2, 3],
                        variances=[0.1, 0.1, 0.2, 0.2],
